  ...
  return (
    <main className="container">
      <div className="header">
        ...
        <div style={{ display: "flex", gap: 8 }}><a className="btn secondary" href="/api-keys">API keys</a><a className="btn secondary" href="/system-status">Status</a><a className="btn secondary" href="/work-queue">Work queue</a><a className="btn secondary" href="/invoice-metadata">Tags/Prioritate</a><a className="btn secondary" href="/invoice-notes">Note facturi</a><a className="btn secondary" href="/client-portal">Portal client</a><a className="btn secondary" href="/settings">Setări</a><a className="btn secondary" href="/audit">Audit</a><a className="btn secondary" href="/onboarding">Onboarding</a><button className="btn secondary" onClick={logout}><LogOut size={16} /> Logout</button></div>
      </div>
